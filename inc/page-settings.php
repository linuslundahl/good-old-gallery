...
function goodold_gallery_settings_init(){
	...
	add_settings_field( 'speed', '<label for="speed">Animation speed</label>', 'goodold_gallery_setting_text', __FILE__, GOG_PLUGIN_SHORT . '_settings', array('id' => 'speed', 'desc' => 'milliseconds', 'size' => 4, 'name' => GOG_PLUGIN_SHORT . '_settings', 'default' => $gog_settings['speed']) );
